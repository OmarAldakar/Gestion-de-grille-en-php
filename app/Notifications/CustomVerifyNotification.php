...
class CustomVerifyNotification extends Notification
{
    /**
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(Lang::get('Vérifier votre adresse email'))
            ->line(Lang::get('Veuillez cliquer sur le bouton ci-dessous pour vérifier votre adresse email.'))
            ->action(Lang::get('Vérifier votre adresse email'), $verificationUrl)
